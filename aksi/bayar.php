...
if($_POST){
    if($_POST['aksi']=='tambah'){ //untuk manajemen
        ...
        $bukti=$nama_file_bukti; //$bukti itu dri database nya
        ...
        //perintah alokasi pembayaran otomatis  //desc limit 1 itu membatasi
        ...
        while($tagihan=mysqli_fetch_array($query_tagihan)){
            ...
            //update tagihan //total terbayar + dibayarkan biar sisa yg udh di tambah yg bru
            ...
            if($alokasi_dana<=0){
                break;
            } //biar berhenti disaat uang nya cm buat 2 bulan biar ga ngabisi memori
        }
...
if($_GET){
    if($_GET['aksi']=='hapus'){
        ...
        //$sql="DELETE FROM bayar WHERE id_bayar=$id_bayar"; //hard delete hapus permanen
