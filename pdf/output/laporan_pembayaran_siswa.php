...
$sql="SELECT bayar.*,siswa.nis,siswa.nama,siswa.kelas,bayar_metode.metode FROM bayar,siswa,bayar_metode WHERE bayar.dihapus_pada IS NULL AND bayar.id_siswa=siswa.id_siswa AND bayar.id_bayar_metode=bayar_metode.id_bayar_metode AND bayar.tanggal_bayar BETWEEN '$tanggal_awal' AND '$tanggal_ahkir' AND bayar.id_siswa=$id_siswa ORDER BY bayar.tanggal_bayar ASC"; //between itu di antara tanggal awal dan ahkir/ ASC dri kecil kebesar / DSC dri besar ke kecil
