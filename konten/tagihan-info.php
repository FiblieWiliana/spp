                                ...
                                while($bayar_alokasi=mysqli_fetch_array($query)){
                                    echo "
                                        <tr>
                                            ...
                                            <td><a href='index.php?p=bayar-alokasi&id_bayar=$bayar_alokasi[id_bayar]' target='blank'>#$bayar_alokasi[id_bayar]</a> <a href='file/buktibayar/$bayar_alokasi[bukti]' target='blank' title='Lihat foto bukti><i class='fas fa-image'></i></a></td>
