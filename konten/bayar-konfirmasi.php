            ...
            <div class="card">
                ...
                <div class="card-body">
                    <form action="aksi/bayar.php" method="post" enctype="multipart/form-data">
                        <!-- enctype="multipart/form-data" fungsi untuk saat mengupload sesuatu sprti file  -->
                        ...
                        <!-- placeholder buat tulisan keterangan gitu klo binggung cek sndri di web nya -->
